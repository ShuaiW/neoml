""" In order to utilize the fast implementation (Cython extensiion) 
of conv and pool forward/backward layers, first run th following command within
the deep_learning directory:
